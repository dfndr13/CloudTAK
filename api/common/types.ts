...
export const FullConfig = Type.Object({
    ...
    'media::playback_url': Type.String({ description: 'Optional browser-facing base URL for HLS playback (e.g. a standard-port reverse proxy) when it differs from media::public_url. Falls back to media::public_url when unset.' }),
